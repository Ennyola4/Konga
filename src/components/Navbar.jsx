        ...
        <header className="header bg-light text-light py-0">
            <div className="container d-flex justify-content-center align-items-center">
                <div className="row w-100">
                    ...
                    <div className="col text-center">
                        <p  className="text-dark my-1">KongaCorperate</p>
                    </div>
                    <div className="col text-center">
        ...
        <ul className="navbar-nav">
            ...
            <form className="mx-5" role="search">
                <div className="input-group mt-4 mb-4" style={{ flexGrow: 1}}>
                    <input className="form-control" type="search" placeholder="Search for products, brands and catergories..." aria-label="Search"
                    style={{ width: '500px', outline: "none", boxShadow: "none", borderTopRightRadius: "0", borderBottomRightRadius: "0", borderColor: "#ced4da", }} />
                    <button className="btn btn-warning" type="submit" style={{ borderTopLeftRadius: "0", borderBottomLeftRadius: "0", borderColor: "transparent"}}><FaSearch className="text-white" /></button>
                </div>
            </form>
